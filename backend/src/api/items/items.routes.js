...
const itemImages = require('./items_image/items_image.routes');


router.use('/:item_id/item_infos', itemInfos);//we shoud pass merge params in router in item_infos table
router.use('/:item_id/item_images', itemImages);//we shoud pass merge params in router in item_infos table
